package com.weshopify.platform.features.brands.commons;
...
import com.weshopify.platform.features.brands.repo.SearchRepository;
...
public class PagingAndSortingHelper {
	...
	public static Pageable createPageable(int pageSize, int pageNum) {
